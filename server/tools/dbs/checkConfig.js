...
Status.findOne()
	.then((status) => {
		...
		const kit = {
			...
			logo_image: existingKitConfigurations.logo_image || existingKitConfigurations.logo_path || process.env.LOGO_IMAGE || 'https://www.azixexchange.com/assets/images/azix-logo.png',
